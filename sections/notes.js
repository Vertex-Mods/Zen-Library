...
export const notesSection = {
  ...
  init: function() {
    const notesViewContainer = parseElement(`<div id="library-notes-view">
            <div id="library-notes-header">
              <input type="text" id="library-notes-search" placeholder="Search notes...">
              <button id="library-notes-add-button" title="Create new note">
            ...
            <div id="library-notes-grid"></div>
          </div>`);

    const notesGrid = notesViewContainer.querySelector("#library-notes-grid");
    const addButton = notesViewContainer.querySelector(
      "#library-notes-add-button",
    );

    const createNoteCard = () => {
      return parseElement(`<div class="library-note-card">
